...
interface FooterProps {
    ...
    currentTimeImage: any;
    fallbackCreditText: string;
}

const Footer: React.FC<FooterProps> = ({ onShowHelpModal, currentTimeImage, fallbackCreditText }) => (
    <footer className="w-full py-4 px-4 sm:py-6 sm:px-8 border-t border-gray-200 dark:border-gray-700">
        <div className="container mx-auto flex flex-col sm:flex-row justify-center sm:justify-between items-center space-y-4 sm:space-y-0">
            ...
            {/* Center Section: Credits + Bunnies to help button */}
            <div className="flex flex-col items-center space-y-2">
                ...
                <button
                    ...
                    className="px-4 py-1.5 bg-pink-100 dark:bg-pink-900 text-pink-700 dark:text-pink-200 rounded-lg font-medium hover:bg-pink-200 dark:hover:bg-pink-800 transition-colors text-xs sm:text-sm"
                >
                    Bunnies to help
                </button>
            </div>
